...
export default {
  ...
  intro: {
    ...
    subtitle: 'Using the Earth Index, an AI algorithm, Mongabay detected 76 clandestine landing strips hidden in the Peruvian Amazon.',
    date: 'Oct. 24 2024',
    social: [
      {
        name: 'twitter',
  ...
  chapters: [
    ...
    },
    {
        ...
        description: 'In these three regions, at least 15 Indigenous leaders have been murdered since the pandemic began in 2020. The area is also home to the largest number of flights shipping cocaine, according to sources from the Anti-Drug Directorate of the National Police of Peru.',
        legend: [
                {
    ...
    },
    {
        ...
        description: 'Crucially, 30 of the 67 narco airstrops were detected within Indigenous territories and 26 more are located near them.',
        location: {
            center: [-74.549, -9.575],
            zoom: 8,
            pitch: 35.12,
    ...
    },
    {
        ...
        description: 'Following up on the satellite imagery analysis, Mongabay Latam journalists reached two communities, located between the regions of Huánuco and Pasco with 15 clandestine landing strips in their territories.',
        location: {
            center: [-74.927, -9.790],
            zoom: 11.06,
            pitch: 16,
    ...
    },
    {
        ...
        description: 'We identified at least 2 illegal airstrips in Kakataibo North and South Indigenous Reserve. In addition, six illegal airfields are affecting at least four reserves specificially designated for Indigenous peoples living in isolation and initial contact (PIACI). Although these territories should be off limits by law, they are not being protected in practice.',
        location: {
    ...
    },
    {
        ...
        description: 'One of the forestry concessions with clandestine airstrips is managed by the company Forestal Mendoza, whose legal representative is Francisco de Asís Mendoza de Souza, the current provincial mayor of Atalaya. He is under investigation for usurpation, embezzlement and money laundering. The Earth Index detected two illegal airstrips within the concession: one opened in June 2018 and the other in June 2020.',
        location: {
    ...
    },
    {
        ...
        description: 'A key investigative finding is that 52 of the 67 narco airstrips located in Ucayali, Huánuco and Pasco — where the most Indigenous leaders have been murdered — are one kilometer from rivers and roads, suggesting these locations are strategic points for transfering drug shipments.',
        location: {
            center: [-74.549, -9.575],
            zoom: 8,
            pitch: 35.12,
